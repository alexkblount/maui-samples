...
{
	public class SettingsIntentCode : ContentPage
	{
		public SettingsIntentCode ()
		{
			this.Title = "Settings Intent";
			var table = new Microsoft.Maui.Controls.TableView () { Intent = TableIntent.Settings };
