...
namespace TextSample
{
	public class EditorPageCode : ContentPage
	{
		public EditorPageCode ()
		{
            ...
            layout.Children.Add(new Editor { Placeholder = "This is placeholder text", PlaceholderColor = Colors.Olive });
            layout.Children.Add(new Editor { Text = "This is a read-only Editor", IsReadOnly = true });
			this.Content = layout;
		}
	}
}
